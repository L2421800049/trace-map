...
public class ConvertUtil {
    ...
    private static String lookupKeyForAsset(String assetName) {
        return FlutterInjector.instance().flutterLoader().getLookupKeyForAsset(assetName);
    }

    private static String lookupKeyForAsset(String assetName, String packageName) {
        return FlutterInjector.instance().flutterLoader().getLookupKeyForAsset(assetName, packageName);
    }
